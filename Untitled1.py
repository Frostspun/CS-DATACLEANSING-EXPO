...
plt.scatter(trending_columns['likes'], trending_columns['dislikes'], s=trending_columns['view_count'] / 1000, alpha=0.5)
plt.xlabel('Likes')
plt.ylabel('Dislikes')
...
plt.scatter(trending_columns['likes'], trending_columns['comment_count'], s=trending_columns['view_count'] / 1000, alpha=0.5)
plt.xlabel('Likes')
...
ytext = ytext.lower()  # Convert to lowercase
ytext = re.sub('['+string.punctuation+']', '', ytext)  # Remove punctuation

# Words to exclude
excluded_words = {'the', 'and', 'or', 'is', 'of','to','in','A','a','On', '1','2','3','4','5','6','7','8', '9', 'To', 'The', 'on', 'my','My', "with","With",'In', 'at', 'You' 'for', 'this','for','we','me' }  
...
# Based on the visualizations I can make a few conclusions, The more likes a video can get the more views it will get, Dislikes negativley impact view counts, Low likes is more impactful to viewership than a high dislike count, Comment counts are important and generally increase with the amount of likes but likes are more important.
# 
# Some titles are better than others, Titles with words like "Official" and "Video" attribute higher viewership. also personalized words like "you" and "for" attribute higherveiwership. Some videos utilize high energy titles with ALL CAPS.
# 
# Lastly some categories are more popular than others, Gaming, Music, Vlogs, and How-to guides seem to be more popular but regardless our analysis focuses on how to make any youtube video more popular regardless of content. So all in all more engagement(Likes, comments) = more views, there is a snowballing effect when it comes to more popular videos as more views also = more engagement, So we can utilize factors like using trending and popular words in our titles and finding ways to gain more engagement in our content (Ie, mentioning to like and comment) on the video. 
